...
9. You may see an error next to your script task.
...
13. Go back to the SAP Build lobby, refresh the page.
...
5. Click the **Purchase** button and open its logic canvas.
